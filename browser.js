...
elliptic.version = (__webpack_require__(597)/* .version */ .i8);
elliptic.utils = __webpack_require__(953);
elliptic.rand = __webpack_require__(931);
elliptic.curve = __webpack_require__(254);
elliptic.curves = __webpack_require__(427);

// Protocols
elliptic.ec = __webpack_require__(954);
elliptic.eddsa = __webpack_require__(980);
...
module.exports = __webpack_require__(119)(__webpack_require__(573))
...
const EC = (__webpack_require__(266).ec)
...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ MultiSignature)
});

;// CONCATENATED MODULE: ./node_modules/@vandeurenglenn/typed-array-concat/concat.js
/* harmony default export */ const concat = ((input, options = {length: undefined, seperator: undefined}) => {
  if (!options) options = {}
...
;// CONCATENATED MODULE: ./node_modules/@vandeurenglenn/base-x/base-x.js
...
;// CONCATENATED MODULE: ./node_modules/@vandeurenglenn/base58/dist/base58.js
...
;// CONCATENATED MODULE: ./node_modules/@vandeurenglenn/base32/dist/base32.js


const base32_ALPHABET = 'abcdefghijklmnopqrstuvwxyz234567';
const base32_ALPHABET_HEX = '0123456789abcdefghijklmnopqrstuv';
const base32 = base(base32_ALPHABET);
const base32Hex = base(base32_ALPHABET_HEX);
const base32_decode = base32.decode;
const base32_decodeHex = base32Hex.decode;
const base32_encode = base32.encode;
const base32_encodeHex = base32Hex.encode;
const isBase32 = (string, hex = false) => {
    try {
        if (hex)
            base32_decodeHex(string);
        else
...
var base32$1 = {
    ...
    encodeHex: base32_encodeHex,
    decodeHex: base32_decodeHex,
    isBase32,
    isBase32Hex
};
...
var elliptic = __webpack_require__(221);
var elliptic_default = /*#__PURE__*/__webpack_require__.n(elliptic);
;// CONCATENATED MODULE: ./node_modules/varint/exports/encode.js
const MSB = 0x80;
const REST = 0x7F;
const MSBALL = ~REST;
const INT = Math.pow(2, 31);
const encode_encode = (num, out, offset) => {
    if (Number.MAX_SAFE_INTEGER && num > Number.MAX_SAFE_INTEGER) {
        encode_encode.bytes = 0;
    ...
    out[offset] = num | 0;
    encode_encode.bytes = offset - oldOffset + 1;
    return out;
};



;// CONCATENATED MODULE: ./node_modules/varint/exports/decode.js
const decode_MSB = 0x80;
const decode_REST = 0x7F;
const decode_decode = (buf, offset) => {
    offset = offset || 0;
    const l = buf.length;
    let counter = offset;
    let result = 0;
    ...
    do {
        if (counter >= l || shift > 49) {
            decode_decode.bytes = 0;
            throw new RangeError('Could not decode varint');
        }
        b = buf[counter++];
        result += shift < 28
            ? (b & decode_REST) << shift
            : (b & decode_REST) * Math.pow(2, shift);
        shift += 7;
    } while (b >= decode_MSB);
    decode_decode.bytes = counter - offset;
    return result;
};



;// CONCATENATED MODULE: ./node_modules/varint/exports/length.js
...
;// CONCATENATED MODULE: ./node_modules/varint/exports/index.js
...
class MultiSignature {
    ...
    sign(hash, privateKey) {
        ...
        const { signature } = elliptic_default().ecdsaSign(hash, privateKey);
        this.decoded = {
   ...
   */
    verifySignature(signature, hash, publicKey) {
        return elliptic_default().ecdsaVerify(signature, hash, publicKey);
    }
    /**
   ...
   */
    verify(multiSignature, hash, publicKey) {
        ...
        return elliptic_default().ecdsaVerify(multiSignature.signature, hash, publicKey);
    }
    encode(signature) {
        signature = signature || this.signature;
        if (!signature)
            throw ReferenceError('signature undefined');
        this.#multiSignature = concat([
            index.encode(this.version),
            index.encode(this.multiCodec),
            signature
        ]);
   ...
   */
    decode(multiSignature) {
        ...
        const version = index.decode(buffer);
        buffer = buffer.subarray(index.decode.bytes);
        const codec = index.decode(buffer);
        buffer = buffer.subarray(index.decode.bytes);
    ...
    toBs32() {
        return base32$1.encode(this.multiSignature);
    }
    fromBs32(string) {
        return this.decode(base32$1.decode(string));
    }
    toBs32Hex() {
        return base32$1.encodeHex(this.multiSignature);
    }
    fromBs32Hex(string) {
        return this.decode(base32$1.decodeHex(string));
    }
    toBs58Hex() {
